...
const Dashboard: React.FC<DashboardProps> = ({ stocks, transactions, language, user }) => {
      ...
      <div>
        ...
        <div className="space-y-3">
            {recentTransactions.map(txn => (
                <div key={txn.id} className="bg-white p-4 rounded-[1.5rem] border border-gray-100 shadow-sm flex justify-between items-center">
                    <div>
