...
import { Save, Building, Phone, MapPin, DollarSign, Type } from 'lucide-react';
    ...
    <div className="p-6 pb-24 space-y-6 animate-in slide-in-from-right duration-300">
      ...
      {toast.show && (
        <div className="fixed top-20 left-1/2 -translate-x-1/2 z-[100] animate-in slide-in-from-top duration-500">
            <div className="px-6 py-3 rounded-full shadow-2xl flex items-center gap-3 border backdrop-blur-md bg-green-600 border-green-500 text-white">
